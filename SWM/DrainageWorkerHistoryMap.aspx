<%@ Page Title="Sweeper History Map" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DrainageWorkerHistoryMap.aspx.cs" Inherits="SWM.DrainageWorkerHistoryMap" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <head>
        ...
        <title>Drainage Worker History Map</title>
    </head>
    <body>
        <div class="container-fluid my-3">
            <div
                class="border mx-2 d-flex justify-content-between align-items-center">
                <h3><i class="fa-solid fa-book mx-2"></i>Drainage Worker History Map</h3>
            ...
            <div class="toggler__content">
                <div class="row border border-top-0 mx-2 py-3">
                    ...
                    <div class="col-lg-2 col-md-3 mt-1">
                        <label for="drainageWorkerDropdown">Drainage Worker Name</label>
                        <select id="drainageWorkerDropdown" class="fstdropdown-select">
                            <option value="0">Select</option>
                        </select>
                    </div>
                    ...
                    <div class="col-lg-auto col-md-3 mt-1">
...
<%--                            <button
        ...
        <script src="js/DrainageWorkerHistoryMap.js"></script>
    </body>
</asp:Content>
