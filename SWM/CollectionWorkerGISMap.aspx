<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CollectionWorkerGISMap.aspx.cs" Inherits="SWM.CollectionWorkerGISMap" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <head>
        ...
        <title>Collection Worker History Map</title>
    </head>
    <body>
        <div class="container-fluid my-3">
            <div
                ...
                <h3>
                    <i class="fa-solid fa-book mx-2"></i>Collection Worker History Map
                </h3>
            ...
            <div class="toggler__content">
                <div class="row border border-top-0 mx-2 py-3">
                    ...
                    <div class="col-lg-2 col-md-3 mt-1">
                        <label for="kothiDropdown">Prabhag</label>
                        <select
                            id="kothiDropdown"
                            class="fstdropdown-select"
                    ...
                    <div class="col-lg-2 col-md-3 mt-1">
                        <label for="wardDropdown">Collection Worker Name</label>
        ...
        <script defer src="js/CollectionWorkerGISMap.js"></script>
    </body>
</asp:Content>
