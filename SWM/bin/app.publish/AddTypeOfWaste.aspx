<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddTypeOfWaste.aspx.cs" Inherits="SWM.AddTypeOfWaste" %>
    ...
    <body>
        <div class="container-fluid my-3">
            <div
                ...
                <h6 class="mb-0">
                    <i class="fa-solid fa-book mx-2"></i>Add Type of Waste
                </h6>
            ...
            <div class="toggler__content">
                <div class="row border border-top-0 mx-2 py-2">
                    <div class="col-lg-2 col-md-3 mt-1">
                        ...
                        <input type="text" class="form-control" id="wasteTypeInput" />
                    </div>
                    <div class="col-lg-2 col-md-3 mt-1">
                        <label for="">Waste Name</label>
                        <input type="text" class="form-control" id="wasteNameInput" />
                    </div>
                    <div class="col-lg-2 col-md-3 mt-1">
                        <label for="userDropdown">Remark</label>
                        <input type="text" class="form-control" id="remarkNameInput" />
                    </div>
        ...
        <script src="js/AddTypeOfWaste.js"></script>
    </body>
</asp:Content>
