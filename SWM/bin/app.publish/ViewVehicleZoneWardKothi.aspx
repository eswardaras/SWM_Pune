<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewVehicleZoneWardKothi.aspx.cs" Inherits="SWM.ViewVehicleZoneWardKothi" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <head>
        ...
        <title>View Vehicle Zone, Ward, Route Info</title>
    </head>
    <body>
        <section
            ...
            <div class="sweeper-coverage-report">
                <div class="title dropdown-btn">
                    <div class="controls">
                        <div>
                            <h2>View Vehicle Zone, Ward, Route Info</h2>
                        </div>
                    </div>
                ...
                <div class="body collapsible active toggler__content">
                    <table class="table table-striped text-center" id="table">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="10" class="text-success">Loading...</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <script defer src="js/ViewVehicleZoneWardRoute.js"></script>
    </body>
</asp:Content>
