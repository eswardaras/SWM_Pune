<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DatewiseWeightReport.aspx.cs" Inherits="SWM.DatewiseWeightReport" %>
    ...
    <body>
            ...
            <section class="sweeper-coverage-report-section">
                <div class="sweeper-coverage-report">
                    ...
                    <div class="collapse show" id="tableCollapse">
                        <div id="frm" class="body collapsible active">
                            <asp:GridView ID="adhocTable" runat="server" AutoGenerateColumns="false" CssClass="table-striped feederCoverage">
                                <Columns>
                                    <asp:BoundField DataField="SRNO" HeaderText="SRNO" />
                                    <asp:BoundField DataField="DATE" HeaderText="DATE" />
                                    <asp:BoundField DataField="TOTAL_WEIGHT(MT)" HeaderText="TOTAL_WEIGHT(MT)" />
                                </Columns>
                            </asp:GridView>
                        </div>
                    </div>
        ...
        <script>
            $(document).ready(function () {
                $(".feederCoverage").prepend($("<thead></thead>").append($(this).find("tr:first"))).DataTable({
                    pageLength: 5,
                    language: {
        ...
        <script>
            function showSpinner() {
                const loadingSpinner = document.querySelector('.spinner_container');
