<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VehicleMapViewHistory1.aspx.cs" Inherits="SWM.VehicleMapViewHistory1" %>
...
function initMap(lat,lon) {
 ...
 var markerf;
    for (var i = 0; i < data.length; i++) {
        ...
        var popupContent = "Time: " + time + "<br/>Speed: " + speed + "<br/>Vehicle Name: " + vehiclename;
