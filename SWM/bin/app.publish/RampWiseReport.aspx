<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RampWiseReport.aspx.cs" Inherits="SWM.RampWiseReport" %>
    ...
    <body>
                    ...
                    <div class="title dropdown-btn">
                        <div class="controls">
                            <div>
                                <h2>Pune Municipal Corporation</h2>
                                |
                            <h3>RampWise Report (Incomming Weight Bifurcation)</h3>
                            </div>
                        </div>
            ...
            <section class="sweeper-coverage-report-section">
                <div class="sweeper-coverage-report">
                    ...
                    <div class="collapse show" id="tableCollapse4">
                        <div class="body collapsible active">
                            <asp:GridView ID="FourthTable" runat="server" CssClass="table-striped fourthTable" AutoGenerateColumns="false" AllowSorting="false">
                                <Columns>
                                    <asp:BoundField DataField="Plant Name" HeaderText="Plant Name" />
                                    <asp:BoundField DataField="Total Trips" HeaderText="Total Trips" />
                                    <asp:BoundField DataField="Total Weight in (MT)" HeaderText="Total Weight in (MT)" />
                                </Columns>
                            </asp:GridView>
                        </div>
                    </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                function initializeDataTableDesc(tableElement) {
                    $(tableElement).prepend($("<thead></thead>").append($(tableElement).find("tr:first"))).DataTable({
                        pageLength: 5,
                        language: {
                            lengthMenu: "_MENU_  records per page",
                ...
                function initializeDataTableAsc(tableElement) {
                    $(tableElement).prepend($("<thead></thead>").append($(tableElement).find("tr:first"))).DataTable({
                        pageLength: 5,
                        language: {
                            lengthMenu: "_MENU_  records per page",
                ...
                initializeDataTableDesc(".firstTable");
                initializeDataTable(".secondTable");
                initializeDataTable(".thirdTable");
                initializeDataTableAsc(".fourthTable");
                initializeDataTableDesc(".fifthTable");
                initializeDataTableDesc(".sixthTable");
            });
        </script>
