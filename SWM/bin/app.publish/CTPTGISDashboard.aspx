<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CTPTGISDashboard.aspx.cs" Inherits="SWM.CTPTGISDashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <head>
        ...
        <title>CT PT Dashboard</title>
    </head>
    <body>
        <div class="container-fluid my-3">
            <div
                class="border mx-2 d-flex justify-content-between align-items-center">
                <h3><i class="fa-solid fa-book mx-2"></i>CT/ PT/ Urinals Dashboard</h3>
            ...
            <div class="toggler__content">
                <div class="row border border-top-0 mx-2 py-3">
                    ...
                    <div class="col-lg-2 col-md-3 mt-1">
                        <label for="wardDropdown">Block Category</label>
                        <select
                            id="blockDropdown"
                            class="fstdropdown-select"
                            onchange="handleBlockSelect(event)">
                            <option value="0">All Category</option>
                            <option value="1">CT</option>
                            <option value="2">PT</option>
                            <option value="3">Urinals</option>
                        </select>
                    </div>
                    <div class="col-lg-2 col-md-3 mt-1">
            ...
            <div class="row justify-content-center">
                <div class="col-auto mb-2">
                    <button type="button" class="btn btn-sm btn-info text-white">
                        ALL <span class="badge text-bg-light" id="totalCount">0</span>
                    </button>
                </div>
                <div class="col-12">
                    <div
        ...
        <script>
            $(document).ready(function () {
                $(".toggler__btn").click(function () {
                    $(".toggler__content").slideToggle("fast");
                });
            });
        </script>
        <script defer src="js/CTPTGISDashboard.js"></script>
    </body>
</asp:Content>
