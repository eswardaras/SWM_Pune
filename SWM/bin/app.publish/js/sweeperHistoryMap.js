...
var overlays = {
    "Sweeper Location": dotMarkerLayer,
    Kothi: Kothilayer,
    Route: routeLayer,
    "GPS Line": linelayer,
};
    ...
    try {
        ...
        const sweeperRequestData = {
            ...
            parameters: JSON.stringify({
                ...
                Fk_KothiId: kothiDropdown.value || 0,
                FK_SweeperID: 0,
                sDate: "",
                eDate: "",
            }),
...
btnShowRoute.addEventListener("click", async (e) => {
    ...
    clearMap();
    if (sweeperDropdown.value) {
        await kothi(sweeperDropdown.value);
    }
    await getRouteId();
});
