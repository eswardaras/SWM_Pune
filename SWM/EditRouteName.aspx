<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditRouteName.aspx.cs" Inherits="SWM.EditRouteName" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <body>
        <div class="container-fluid my-3" id="editPanel" style="display: none">
            <div
                class="border mx-2 d-flex justify-content-between align-items-center">
                <h6 class="mb-0">
                    <i class="fa-solid fa-book mx-2"></i>Edit Route Name
                </h6>
            ...
            <div class="toggler__content">
                <div class="row border border-top-0 mx-2 py-2">
                    <div class="col-lg-3 col-md-4 mt-1 stateDropdownWrapper">
                        ...
                        <input type="text" class="form-control" id="routeNameInput" />
                    </div>
        ...
        <section class="sweeper-coverage-report-section" id="tableWrapper">
            <div class="sweeper-coverage-report">
                <div
                    class="border border-top-0 border-start-0 border-end-0 d-flex justify-content-between align-items-center">
                    <h6 class="mb-0">
                        <i class="fa-solid fa-book mx-2"></i>Route Info
                    </h6>
                    <button type="button" class="btn btn-light h-100 toggler__btn">
                        <i class="fa-solid fa-chevron-down"></i>
                    </button>
        ...
        <script src="js/EditRouteName.js"></script>
    </body>
</asp:Content>
