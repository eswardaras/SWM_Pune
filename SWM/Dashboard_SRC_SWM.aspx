<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Dashboard_SRC_SWM.aspx.cs" Inherits="Dashboard_SRC_SWM" %>
...
<body>
    <div id="form1" >
        ...
        <div class="main-content" id="mainContent">
                    ...
                    <h1>Sweeper Route Coverage Report</h1>
    ...
    <input type="date"
        ...
        style="position: absolute; visibility: hidden; width: 0; height: 0;">
            ...
            <div class="filter-bar">
                ...
                <div class="filter-group">
                    <label for="selectSweeper">SweeperName</label>
                    <select id="selectSweeper"><option value="all">Select Sweeper</option></select>
                </div>
            </div>
        ...
        <script>
            ...
            function renderOverallCoverage() {
                const url = "https://iswmpune.in/api/SWCoverage";
            ...
            function renderWardWiseCoverage() {
                const url = "https://iswmpune.in/api/SweeperCoverageWardWise";
            ...
            function renderTop10Table() {
                ...
                const apiUrl = "https://iswmpune.in/api/Top10Sweepers";
            ...
            function renderBottom10Table() {
                ...
                const apiUrl = "https://iswmpune.in/api/Bottom10Sweepers";
