...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <style>
     ...
     .header-bar h1 {
        ...
        .filter-bar label {
            font-weight: bold;
            color: #fff; /* Green text matching screenshot label color */
            font-size: 14px;
            display: block;
            margin-bottom: 5px;
            text-align: center;
...
<body>
    ...
    <script type="text/javascript">
        ...
        function renderMokadamOverall() {
            ...
            $.ajax({
                type: "GET",
                url: "https://iswmpune.in/api/MokadamAttendence",
        ...
        function renderMokadamZoneWise() {
            ...
            $.ajax({
                type: "GET",
                url: "https://iswmpune.in/api/MokadamAttendanceZoneWise",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (apiData) {
                    toggleLoader(chartId, false); // Hide loader on success
        ...
        function renderMokadamWardWise() {
            ...
            $.ajax({
                type: "GET",
                url: "https://iswmpune.in/api/MokadamAttendanceWardWise",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (apiData) {
                    toggleLoader(chartId, false); // Hide loader on success
