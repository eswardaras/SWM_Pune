...
namespace SWM
{
    public partial class IMEIPingStatus : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                //myIframe.Src = ConfigurationManager.AppSettings["IMEIPingStatusPath"];
                string mainDashboardPath = ConfigurationManager.AppSettings["IMEIPingStatusPath"];
