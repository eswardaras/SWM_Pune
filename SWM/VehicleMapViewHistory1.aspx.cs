...
namespace SWM
{
    public partial class VehicleMapViewHistory1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet dsroute = bAL.getroute(Convert.ToInt16(vehicleid), Convert.ToInt16(routeid), sd, ed);
