<%@ Page Title="Sweeper History Map" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SweeperHistoryMap.aspx.cs" Inherits="SWM.SweeperHistoryMap" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <head>
        ...
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/leaflet-arrowheads/dist/leaflet-arrowheads.css" />
        <script src="https://cdn.jsdelivr.net/npm/leaflet-arrowheads/dist/leaflet-arrowheads.min.js"></script>
        <link rel="stylesheet" href="https://unpkg.com/leaflet@1.7.1/dist/leaflet.css" />
        <script src="https://unpkg.com/leaflet@1.7.1/dist/leaflet.js"></script>
        <script src="https://unpkg.com/leaflet-polylinedecorator@1.2.0/dist/leaflet.polylineDecorator.js"></script>


        <title>Sweeper History Map</title>
    </head>
    <body>
        <div class="container-fluid my-3">
            <div
                class="border mx-2 d-flex justify-content-between align-items-center">
                <h3><i class="fa-solid fa-book mx-2"></i>Sweeper History Map</h3>
            ...
            <div class="toggler__content">
                <div class="row border border-top-0 mx-2 py-3">
                    ...
                    <div class="col-lg-2 col-md-3 mt-1">
                        <label for="wardDropdown">Sweeper Name</label>
                        <select id="sweeperDropdown" class="fstdropdown-select">
                            <option value="0">Select</option>
                        </select>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-3 mt-1">
                        <div class="d-flex align-items-end h-100">
                            <button class="btn btn-primary me-1" type="submit" id="btnShowRoute">
                                Show Route
                            </button>
                            <button class="btn btn-success me-1 text-white" type="submit" id="btnPlay">
                                <i class="fa-regular fa-circle-play text-white"></i>
                                Play
                            </button>
                            <button class="btn btn-warning text-white" type="button" id="btnRefresh">
                                Refresh
                            </button>
                        </div>
                    </div>
        ...
        <script src="js/sweeperHistoryMap.js"></script>
    </body>
</asp:Content>
