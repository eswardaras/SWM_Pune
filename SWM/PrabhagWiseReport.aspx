<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PrabhagWiseReport.aspx.cs" Inherits="SWM.PrabhagWiseReport" %>
    ...
    <body>
            ...
            <div class="filters-container">
                <div class="title d-flex justify-content-between">
                    <div class="d-flex align-items-center">
                        ...
                        <h3>Prabhag Wise Weight Report</h3>
                    </div>
                ...
                <div class="sweeper-coverage-report">
                    ...
                    <div class="collapse show" id="tableCollapse">
                        <div class="body collapsible active">
                            <asp:GridView ID="adhocTable" runat="server" AutoGenerateColumns="true" CssClass="table-striped PrabhagWise">
                            </asp:GridView>
                        </div>
                    </div>
                </div>
        ...
        <script>
            $(document).ready(function () {
                $(".PrabhagWise").prepend($("<thead></thead>").append($(this).find("tr:first"))).DataTable({
                    pageLength: 5,
                    language: {
