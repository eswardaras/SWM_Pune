<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AssignEmpRelation.aspx.cs" Inherits="SWM.AssignEmpRelation" %>
    ...
    <body>
        <div class="container-fluid my-3" id="editPanel">
            <div
                ...
                <h6 class="mb-0">
                    <i class="fa-solid fa-book mx-2"></i>Assign Role to Employees
                </h6>
            ...
            <div class="toggler__content">
                ...
                <div class="row border border-top-0 mx-2 py-2">
                    ...
                    <div class="col-lg-3 col-md-4 mt-1 content1">
                        ...
                        <select  class="form-select" id="RoleDropdown" multiple>  </select>
                    </div>
                    <div class="col-lg-3 col-md-4 mt-1 content1">
                        <label for="EmpDropdown">Select Employee</label>
                        <select class="form-select" id="EmpDropdown" multiple></select>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 mt-1 content2" style="display: none">
                        ...
                        <select class="form-select" id="employeeDropdown1" multiple>
