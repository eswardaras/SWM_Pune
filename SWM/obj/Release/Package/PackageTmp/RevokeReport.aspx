<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RevokeReport.aspx.cs" Inherits="SWM.RevokeReport" %>
                ...
                <div class="collapse show" id="tableCollapse2">
                    <div class="body collapsible active toggler__content1">
                        <asp:GridView ID="grdData" runat="server" CssClass="table-striped adhoctable" AutoGenerateColumns="true" OnRowDataBound="grdData_RowDataBound">
                             <Columns>
                                <asp:TemplateField ItemStyle-Width="30px" HeaderText="Revoke/Terminate Status">
                                    <ItemTemplate>
                                        <asp:LinkButton CssClass="btn btn-sm btn-warning text-white mb-1" ID="btnRevoke" runat="server" Text="Revoke" CommandName="Revoke" OnClick="btnRevoke_Click"
                                            CommandArgument='<%# Eval("Pk_RevokeId") %>' />
                                        <asp:LinkButton CssClass="btn btn-sm btn-danger mb-1" ID="btnTerminate" runat="server" Text="Terminate" CommandName="Terminate" OnClick="btnTerminate_Click"
                                             CommandArgument='<%# Eval("Pk_RevokeId") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
