<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddFeederPoint.aspx.cs" Inherits="SWM.AddFeederPoint" %>
    ...
    <body>
        <div class="container-fluid my-3" id="editPanel">
            <div
                ...
                <h6 class="mb-0">
                    <i class="fa-solid fa-book mx-2"></i>Add Feeder Point
                </h6>
            ...
            <div class="toggler__content">
                <div class="row border border-top-0 mx-2 py-2">
                    ...
                    <div class="col-lg-2 col-md-3 mt-1">
                        ...
                        <select id="routeDropdown" class="fstdropdown-select">
                            <option value="0">Select Route</option>
                        </select>
                    </div>
                    <div class="col-lg-2 col-md-3 mt-1">
                        <label for="feederNameInput">Feeder Name</label>
                        <input type="text" class="form-control" id="feederNameInput" />
                    </div>
                    <div class="col-lg-2 col-md-3 mt-1">
                    ...
                    <div class="col-lg-2 col-md-3 mt-1">
                        <label for="expectedTimeInput">Expected Time</label>
                        <input type="time" class="form-control" id="expectedTimeInput" />
                    </div>
        ...
        <div class="container-fluid bg-light">
            Go to old iswm web app:- <a href="http://3.6.47.39:5050/Login.aspx" target="_blank">iswmpune</a>
        </div>
        ...
        <script src="js/AddFeederPoint.js"></script>
    </body>
</asp:Content>
