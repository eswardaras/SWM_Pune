<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VehicleTypeWiseReport.aspx.cs" Inherits="SWM.VehicleTypeWiseReport" %>
    ...
    <body>
            ...
            <div class="filters-container">
                <div class="title d-flex justify-content-between">
                    <div class="d-flex align-items-center">
                        ...
                        <h3>Vehicle Type Wise Report</h3>
                    </div>
                    <asp:Button ID="btnSearch" runat="server" Text="Show" OnClick="btnSearch_Click" CssClass="btn btn-sm btn-success" />
                </div>
                <div class="body">
                ...
                <div class="sweeper-coverage-report">
                    ...
                    <div class="collapse show" id="tableCollapse">
                        <div class="body collapsible active">
                            <asp:GridView ID="adhocTable" runat="server" AutoGenerateColumns="true" CssClass="table-striped vehicleTypeWise">
                            </asp:GridView>
                        </div>
                    </div>
                </div>
        ...
        <script>
            $(document).ready(function () {
                $(".vehicleTypeWise").prepend($("<thead></thead>").append($(this).find("tr:first"))).DataTable({
                    pageLength: 5,
                    language: {
