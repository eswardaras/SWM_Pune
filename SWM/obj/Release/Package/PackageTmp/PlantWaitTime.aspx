<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PlantWaitTime.aspx.cs" Inherits="SWM.PlantWaitTime" %>
    ...
    <body>
                ...
                <div class="body">
                    <div class="row px-4 pb-4">
                        <div class="col-sm-4">
                            ...
                            <select class="fstdropdown-select" id="ddlPlant"></select>
                        </div>
        ...
        <div class="container-fluid my-3" id="editPanel">
           <%-- <div
                ...
                <h6 class="mb-0">
                    <i class="fa-solid fa-book mx-2"></i>Plant Wait Time
                </h6>
            ...
            <div class="border mx-2 d-flex justify-content-between align-items-center">
                ...
                <!-- Right-side container: label + button -->
                <div class="d-flex align-items-center gap-2">
                    <span id="dataStatusLabel" class="badge bg-info text-dark" style="font-size: 0.9rem;">
                        <!-- Filled by JS -->
                    </span>
                    <button type="button" class="btn btn-light h-100 toggler__btn">
                        <i class="fa-solid fa-chevron-down"></i>
        ...
        <script src="js/PlantWaitTime.js"></script>
    </body>
</asp:Content>
