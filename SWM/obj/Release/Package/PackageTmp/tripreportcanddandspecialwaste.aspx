<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tripreportcanddandspecialwaste.aspx.cs" Inherits="SWM.tripreportcanddandspecialwaste" %>
                ...
                <div class="sweeper-coverage-report">
                    ...
                    <div class="collapse show" id="tableCollapse">
                        <div class="body collapsible active">
                            <asp:GridView ID="adhoctable" runat="server" AutoGenerateColumns="false" CssClass="table-striped adhoctable">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Request_Date" HeaderText="Request Date" DataFormatString="{0:MM/dd/yyyy}" />
                                    <asp:BoundField DataField="Assigined_Vehicle" HeaderText="Assigned Vehicle" />
                                    <asp:BoundField DataField="Completed_Date" HeaderText="Completed Date" DataFormatString="{0:MM/dd/yyyy}" />
                                    <asp:BoundField DataField="StarterName" HeaderText="Starter Name" />
